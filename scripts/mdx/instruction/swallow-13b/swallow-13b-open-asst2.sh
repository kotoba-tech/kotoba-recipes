...
CHECKPOINT_SAVE_DIR="/model/fujii/checkpoints/Swallow-13b/open-asst2-lr_${LR}-minlr_${MIN_LR}"
...
# job name
JOB_NAME="Swallow-13b-VE-open-asst2-BS=${GLOBAL_BATCH_SIZE}-LR=${LR}-MINLR=${MIN_LR}"
