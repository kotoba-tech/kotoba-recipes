...
CHECKPOINT_SAVE_DIR="/model/fujii/checkpoints/Mistral-7b-VE-algebric-stack/open-asst2-lr_${LR}-minlr_${MIN_LR}"
...
# job name
JOB_NAME="Mistral-7b-VE-open-asst2-BS=${GLOBAL_BATCH_SIZE}-LR=${LR}-MINLR=${MIN_LR}"
