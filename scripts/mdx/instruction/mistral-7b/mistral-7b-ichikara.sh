...
CHECKPOINT_SAVE_DIR="/model/fujii/checkpoints/Mistral-7b-VE-algebric-stack/ichikara-lr_${LR}-minlr_${MIN_LR}"
...
# job name
JOB_NAME="Mistral-7b-VE-ichikara-BS=${GLOBAL_BATCH_SIZE}-LR=${LR}-MINLR=${MIN_LR}"
