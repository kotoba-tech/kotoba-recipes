...
SGE_JOB_HOSTLIST=scripts/mdx/hostfile_swallow_7b_open_asst2
...
CHECKPOINT_SAVE_DIR="/model/fujii/checkpoints/Swallow-7b/open-asst2-lr_${LR}-minlr_${MIN_LR}"

mkdir -p ${CHECKPOINT_SAVE_DIR}

# data config

DATASET_DIR=/model/fujii/datasets/instruction/swallow/instruction/open_asst2

TRAIN_DATA_PATH=${DATASET_DIR}/train.jsonl
VALID_DATA_PATH=${DATASET_DIR}/val.jsonl

# job name
JOB_NAME="Swallow-7b-VE-open-asst2-BS=${GLOBAL_BATCH_SIZE}-LR=${LR}-MINLR=${MIN_LR}"
