...
CHECKPOINT_SAVE_DIR="/model/fujii/checkpoints/Swallow-7b/ichikara-lr_${LR}-minlr_${MIN_LR}"
...
# job name
JOB_NAME="Swallow-7b-VE-ichikara-BS=${GLOBAL_BATCH_SIZE}-LR=${LR}-MINLR=${MIN_LR}"
