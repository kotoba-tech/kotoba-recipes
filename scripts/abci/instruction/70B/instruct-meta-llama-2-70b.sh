...
# checkpoint path
CHECKPOINTS_PATH=/bb/llm/gaf51275/llama/checkpoints/instruct/70b/llama-2-70b-base-meta
mkdir -p $CHECKPOINTS_PATH

# model dir
MODEL_DIR=/bb/llm/gaf51275/llama/huggingface-checkpoint/Llama-2-70b-hf
...
mpirun -np $NUM_GPUS \
  ...
  --wandb_name "llama2-70b-base-meta-instruct"
