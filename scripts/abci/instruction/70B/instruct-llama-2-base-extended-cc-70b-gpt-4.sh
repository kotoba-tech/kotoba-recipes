...
# checkpoint path
CHECKPOINTS_PATH=/bb/llm/gaf51275/llama/checkpoints/instruct/gpt-4-instruct/70b/llama-2-70b-base-extended-cc
...
mpirun -np $NUM_GPUS \
  ...
  --wandb_name "gpt-4-llama2-70b-base-extended-cc-instruct"
