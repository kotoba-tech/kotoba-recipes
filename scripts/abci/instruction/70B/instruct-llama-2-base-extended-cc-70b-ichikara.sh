...
DATASET_DIR="/groups/gaf51275/llama/datasets/riken/11-30/tuning"

# checkpoint path
CHECKPOINTS_PATH=/bb/llm/gaf51275/llama/checkpoints/instruct/ichikara/70b/llama-2-70b-base-extended-cc
mkdir -p $CHECKPOINTS_PATH

# model dir
MODEL_DIR=/bb/llm/gaf51275/llama/from_megatron_hf_checkpoints/hf_checkpoints/Llama-2-70b-extended-cc/Llama2-70b-base-extended-cc-megatron-iter0025000
...
mpirun -np $NUM_GPUS \
  ...
  --run_validation \
  --val_data_path $DATASET_DIR/val.jsonl \
  ...
  --wandb_name "ichikara-llama2-70b-base-extended-cc-instruct"
