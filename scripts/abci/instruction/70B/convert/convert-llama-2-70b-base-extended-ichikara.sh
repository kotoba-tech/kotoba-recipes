...
for ((i = start; i <= end; i += increment)); do
  ...
  CHECK_POINT_PATH=/bb/llm/gaf51275/llama/checkpoints/instruct/ichikara/70b/llama-2-70b-base-extended-cc/${FORMATTED_ITERATION}/model.pt
  OUTPUT_PATH=/groups/gaf51275/llama/checkpoints/hf_checkpoints/instruct-ichikara/llama-2-70b-base-extended-cc/${FORMATTED_ITERATION}
