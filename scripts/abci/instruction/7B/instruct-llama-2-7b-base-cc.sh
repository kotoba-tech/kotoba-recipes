...
# checkpoint path
CHECKPOINTS_PATH=/groups/gaf51275/llama/checkpoints/instruct/llama-2-7b-base-cc
mkdir -p $CHECKPOINTS_PATH

# model dir
MODEL_DIR=/bb/llm/gaf51275/llama/from_megatron_hf_checkpoints/hf_checkpoints/Llama2-7b-base-default/okazaki_lab_cc/iter_0025000
...
mpirun -np $NUM_GPUS \
  ...
  --wandb_name "llama2-7b-base-cc-instruct"
