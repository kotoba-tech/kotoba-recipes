...
# checkpoint path
CHECKPOINTS_PATH=/groups/gaf51275/llama/checkpoints/instruct/japanese-stability-stablelm-alpha-7b
mkdir -p $CHECKPOINTS_PATH

# model dir
MODEL_DIR=/groups/gaf51275/llama/hf_checkpoints/japanese-stablelm-base-alpha-7b
...
mpirun -np $NUM_GPUS \
  ...
  --wandb_name "japanese-stablelm-alpha-7b"
