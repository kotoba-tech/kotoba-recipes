...
# checkpoint path
CHECKPOINTS_PATH=/groups/gaf51275/llama/checkpoints/instruct/cyberagent-calm-2-7b
mkdir -p $CHECKPOINTS_PATH

# model dir
MODEL_DIR=/groups/gaf51275/llama/hf_checkpoints/calm2-7b
...
mpirun -np $NUM_GPUS \
  ...
  --wandb_name "cyberagent-calm-2-7b"
