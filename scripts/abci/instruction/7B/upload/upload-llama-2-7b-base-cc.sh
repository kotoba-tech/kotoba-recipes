...
upload_base_dir=/groups/gaf51275/llama/checkpoints/hf_checkpoints/instruct/llama-2-7b-base-cc
...
for ((i = start; i <= end; i += increment)); do
  ...
  python scripts/kotoba/upload/upload.py \
    ...
    --repo-name tokyotech-llm/instruct-abci-llama-2-7b-base-cc-iter$(printf "%07d" $i)
done
