...
for ((i = start; i <= end; i += increment)); do
  ...
  CHECK_POINT_PATH=/groups/gaf51275/llama/checkpoints/instruct/llama-2-7b-base-extended-cc/${FORMATTED_ITERATION}/model.pt
  OUTPUT_PATH=/groups/gaf51275/llama/checkpoints/hf_checkpoints/instruct/llama-2-7b-base-extended-cc/${FORMATTED_ITERATION}
