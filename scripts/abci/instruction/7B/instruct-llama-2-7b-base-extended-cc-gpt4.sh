...
# checkpoint path
CHECKPOINTS_PATH=/groups/gaf51275/llama/checkpoints/instruct/gpt-4-instruct/llama-2-7b-base-extended-cc
...
mpirun -np $NUM_GPUS \
  ...
  --wandb_name "gpt-4-llama2-7b-base-extended-cc-instruct"
