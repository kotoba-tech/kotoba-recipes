...
# checkpoint path
CHECKPOINTS_PATH=/groups/gaf51275/llama/checkpoints/instruct/llama-2-7b-base-meta
mkdir -p $CHECKPOINTS_PATH

# model dir
MODEL_DIR=/bb/llm/gaf51275/llama/huggingface-checkpoint/Llama-2-7b-hf
...
mpirun -np $NUM_GPUS \
  ...
  --wandb_name "llama2-7b-base-meta-instruct"
