...
# checkpoint path
CHECKPOINTS_PATH=/groups/gaf51275/llama/checkpoints/mixtral-7bx8/instruct/gpt-4/gb-128
mkdir -p $CHECKPOINTS_PATH

# model dir
MODEL_DIR=/bb/llm/gaf51275/llama/huggingface-checkpoint/Mixtral-8x7B-v0.1
...
mpirun -np $NUM_GPUS \
  ...
  --wandb_name "instruct-gpt-4-mixtral-7bx8"
