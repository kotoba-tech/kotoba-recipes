...
from llama_recipes.configs.datasets import customer_support_dataset


PROMPT_DICT: dict[str, str] = {"prompt_input": ("タイトル: {title}\n" "本文: {voice}\n" "返信: ")}


class CustomerSupportDataset(Dataset):
    def __init__(
        self,
        dataset_config: Type[customer_support_dataset],
